...
NLWeb is a collection of open protocols and associated open source tools. Its primary focus is to establish a foundational layer for the AI Web — much like how HTML revolutionized document sharing. To make this vision a reality, NLWeb provides practical implementation code. These are not definitive solutions, but proof-of-concept examples demonstrating one possible approach. The community is encouraged to build diverse and innovative implementations beyond these examples, much like the evolution of the web itself.
...
This project may include trademarks or logos for third-party projects, products, or services. Use of Microsoft trademarks or logos is subject to [Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/en-us/legal/intellectualproperty/trademarks/usage/general). Use of third-party trademarks or logos must comply with their respective policies.
